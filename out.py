...
def reg():
    ...
    jalan('  EASYPAISA ACCOUNT NO (03188214452) ')
    jalan('  EASYPAISA ACCOUNT NAME (RIAZKHAN) ')
    ...
    r = requests.get('https://raw.githubusercontent.com/Red-Mafia/fiile/main/sever.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+923188214453')
